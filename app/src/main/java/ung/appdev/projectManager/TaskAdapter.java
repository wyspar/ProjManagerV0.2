...
public class TaskAdapter extends ArrayAdapter<Task>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int currentTaskNumber = cTask.getTaskNumber();
        ...
        TextView numberTextView = (TextView) listItemView.findViewById(R.id.tasks);
        // Get the version name from the current Project object and
        // set this text on the name TextView
        nameTextView.setText(currenttask);
        numberTextView.setText(currentTaskNumber+") ");
